...
#EXPIRED
expired=$(curl -sS https://raw.githubusercontent.com/kidarr/1/main/permission/ip | grep $MYIP | awk '{print $3}')
echo $expired > /root/expired.txt
today=$(date -d +1day +%Y-%m-%d)
while read expired
do
	exp=$(echo $expired | curl -sS https://raw.githubusercontent.com/kidarr/1/main/permission/ip | grep $MYIP | awk '{print $3}')
	if [[ $exp < $today ]]; then
		Exp2="\033[1;31mExpired\033[0m"
        else
        Exp2=$(curl -sS https://raw.githubusercontent.com/kidarr/1/main/permission/ip | grep $MYIP | awk '{print $3}')
	fi
...
echo -e "                 • MENU AKUN •                 "
echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e " [\e[36m•1\e[0m] SSH Akun"
echo -e " [\e[36m•2\e[0m] Vmess Akun"
echo -e " [\e[36m•3\e[0m] Vless Akun"
echo -e " [\e[36m•4\e[0m] Shadowsocks Akun"
echo -e " [\e[36m•5\e[0m] Trojan Akun"
echo -e " [\e[36m•6\e[0m] System Akun"
...
echo -e " \e[33mScript by   \E[0m: Kidar-sc"
